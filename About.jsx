...
function About() {
  return (
    <div className='w-full p-14 bg-[#CDEA68] rounded-tl-3xl rounded-tr-3xl text-black'>
        <h1 className="font-['Neue_Montreal'] text-[4vw] leading-[5vw] tracking-tight">
        ...
        <div className="w-full flex gap-5 border-t-[1px] pt-10 mt-10 border-[#a1b562]">
          <div className="w-1/2 ">
            ...
            <button className="flex uppercase gap-10 items-center px-2 py-3 bg-zinc-900 mt-10 rounded-full text-white">Read More
